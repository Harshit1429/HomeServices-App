...
class ArchitectsList extends StatefulWidget {
  const ArchitectsList({super.key});

  @override
  State<ArchitectsList> createState() => _ArchitectsListState();
}

class _ArchitectsListState extends State<ArchitectsList> {
  List<FavUserModel> lists=[
    FavUserModel(
        images: "assets/images/arc 1.jpeg",
        text: "A.K Architects",
        text1: "All Designs ",
        text2: "⭐ 4.5",
    ...
    FavUserModel(
        images: "assets/images/arc 2.jpeg",
        text: "P.K Arts ",
    ...
    FavUserModel(
        images: "assets/images/arc 3.jpg",
        text: "D&T Groups",
        text1: "New designs",
        text2: "⭐ 4.5",
        text3: "5+ years of experience",
    ...
    FavUserModel(
        images: "assets/images/arc 4.jpg",
        text: "ZK Architects ",
    ...
    FavUserModel(
        images: "assets/images/arc 5.jpg",
        text: "Laxmi Homes",
  ...
  Widget build(BuildContext context) {
    return  SafeArea(child: Scaffold(
      appBar: AppBar(
        ...
        title: const Text(" Architects 🏭 ",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
        centerTitle: true,
