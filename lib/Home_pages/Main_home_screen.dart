...
import 'Home_Construction_List/View_All.dart';
import 'Home_Services_List/Services_List_All.dart';
import 'Notification_Page.dart';
import 'Popular_Services/View_All.dart';
...
class _MainScreenPageState extends State<MainScreenPage> {
  ...
  Widget build(BuildContext context) {
            ...
            Padding(
              ...
              child: GridView.builder(
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      Myindexes.serviceslist = index;
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const HomeservicesList()));
    ...
    setState(() {
    preferences.setBool(SplashScreen.KEYLOGIN, false);
